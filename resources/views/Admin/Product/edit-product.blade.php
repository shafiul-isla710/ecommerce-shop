...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" action="{{ route('update.product',$product->id) }}" method="POST" enctype="multipart/form-data">
                 @csrf
                 @method('PUT')
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            ...
                            <div class="item" id="imgpreview" >
                                <img src="{{ asset('upload/products_images/' . $product->image) }}" class="effect8"
                                    alt="">
                            </div>
                            @endif
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter regular price" name="price"
                                tabindex="0" value="{{ $product->price }}" aria-required="true" required="">
                        </fieldset>
                        @error('regular_price')
                            <span class='alert alert-danger'>{{ $message }}</span>
                        @enderror
